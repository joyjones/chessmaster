...
class Common_util_pub
{
	...
	public function getSign($Obj)
	{
		...
		//签名步骤一：按字典序排序参数
		ksort($Parameters);
		file_put_contents('../logs/sign.log', "---getSign step1:\r\n".print_r($Parameters, true)."\r\n", FILE_APPEND);
		$String = $this->formatBizQueryParaMap($Parameters, false);
		file_put_contents('../logs/sign.log', "---getSign step2:\r\n".$String."\r\n", FILE_APPEND);
		//echo '【string1】'.$String.'</br>';
		//签名步骤二：在string后加入KEY
		$String = $String."&key=".WxPayConf_pub::KEY;
		file_put_contents('../logs/sign.log', "---getSign step3:\r\n".$String."\r\n", FILE_APPEND);
		//echo "【string2】".$String."</br>";
		//签名步骤三：MD5加密
		$String = md5($String);
		file_put_contents('../logs/sign.log', "---getSign step4:\r\n".$String."\r\n", FILE_APPEND);
		//echo "【string3】 ".$String."</br>";
		//签名步骤四：所有字符转为大写
		$result_ = strtoupper($String);
		file_put_contents('../logs/sign.log', "---getSign step5:\r\n".$result_."\r\n", FILE_APPEND);
...
class Wxpay_server_pub extends Common_util_pub 
{
	...
	function executeUrl($url, $ispost = false)
	{
        $curl = curl_init();
